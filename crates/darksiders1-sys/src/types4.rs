...
pub struct hkpSingleShapeContainer {
    // hkpShapeContainer
    pub vfptr: *const hkpSingleShapeContainer__vftable,
    // hkpSingleShapeContainer
    pub m_childShape: *const hkpShape,
}

unsafe impl UpcastToNop<hkpShapeContainer> for hkpSingleShapeContainer {}

impl hkpSingleShapeContainer {
    pub unsafe extern "thiscall" fn __vecDelDtor(&self, a1: u32) -> *mut () {
        ((*self.vfptr).__vecDelDtor)(self as *const _ as *mut _, a1)
    }
...
#[repr(C)]
pub struct hkpSingleShapeContainer__vftable {
    pub __vecDelDtor:
        unsafe extern "thiscall" fn(this: *mut hkpSingleShapeContainer, _: u32) -> *mut (),
    pub getNumChildShapes: unsafe extern "thiscall" fn(this: *const hkpSingleShapeContainer) -> i32,
    pub getFirstKey: unsafe extern "thiscall" fn(this: *const hkpSingleShapeContainer) -> u32,
    pub getNextKey:
        unsafe extern "thiscall" fn(this: *const hkpSingleShapeContainer, _: u32) -> u32,
    pub getCollisionFilterInfo:
        unsafe extern "thiscall" fn(this: *const hkpSingleShapeContainer, _: u32) -> u32,
    pub getChildShape: unsafe extern "thiscall" fn(
        this: *const hkpSingleShapeContainer,
        _: u32,
        _: *mut hkpShapeBufferStorage,
    ) -> *const hkpShape,
    pub isWeldingEnabled: unsafe extern "thiscall" fn(this: *const hkpSingleShapeContainer) -> bool,
}

#[repr(C)]
pub struct hkpShapeCollection {
    // hkBaseObject
    pub vfptr: *const hkpShapeCollection__vftable,
    // hkReferencedObject
    pub m_memSizeAndRefCount: u32,
    // hkcdShape
    pub m_type: hkEnum_enum_hkcdShapeType__ShapeTypeEnum_unsigned_char_,
    ...
    pub m_userData: u32,
    // hkpShapeContainer
    pub vfptr_2: *const hkpShapeCollection__vftable,
    // hkpShapeCollection
    pub m_disableWelding: hkBool,
    pub m_collectionType: hkEnum_enum_hkpShapeCollection__CollectionType_unsigned_char_,
}

unsafe impl UpcastToNop<hkpShape> for hkpShapeCollection {}

unsafe impl UpcastToNop<hkpShapeBase> for hkpShapeCollection {}

unsafe impl UpcastToNop<hkcdShape> for hkpShapeCollection {}

unsafe impl UpcastToNop<hkReferencedObject> for hkpShapeCollection {}

unsafe impl UpcastToNop<hkBaseObject> for hkpShapeCollection {}

unsafe impl UpcastTo<hkpShapeContainer> for hkpShapeCollection {
    fn upcast_to(p: *const Self) -> *const hkpShapeContainer {
        (p as usize + 0x10) as *const _
    }
}

impl hkpShapeCollection {
    pub unsafe extern "thiscall" fn __vecDelDtor(&self, a1: u32) -> *mut () {
        ((*self.vfptr).__vecDelDtor)(self as *const _ as *mut _, a1)
    }
...
#[repr(C)]
pub struct hkpShapeCollection__vftable {
    pub __vecDelDtor: unsafe extern "thiscall" fn(this: *mut hkpShapeCollection, _: u32) -> *mut (),
    pub getNumChildShapes: unsafe extern "thiscall" fn(this: *const hkpShapeCollection) -> i32,
    pub getFirstKey: unsafe extern "thiscall" fn(this: *const hkpShapeCollection) -> u32,
    pub getNextKey: unsafe extern "thiscall" fn(this: *const hkpShapeCollection, _: u32) -> u32,
    pub getCollisionFilterInfo:
        unsafe extern "thiscall" fn(this: *const hkpShapeCollection, _: u32) -> u32,
    pub getChildShape: unsafe extern "thiscall" fn(
        this: *const hkpShapeCollection,
        _: u32,
        _: *mut hkpShapeBufferStorage,
    ) -> *const hkpShape,
    pub isWeldingEnabled: unsafe extern "thiscall" fn(this: *const hkpShapeCollection) -> bool,
    ...
    pub getCentre: unsafe extern "thiscall" fn(this: *const hkpShapeCollection, _: *mut hkVector4f),
    pub getNumCollisionSpheres: unsafe extern "thiscall" fn(this: *const hkpShapeCollection) -> i32,
    ...
    pub getContainer:
        unsafe extern "thiscall" fn(this: *const hkpShapeCollection) -> *const hkpShapeContainer,
    pub getMaximumProjection:
        unsafe extern "thiscall" fn(this: *const hkpShapeCollection, _: *const hkVector4f) -> f32,
    ...
    pub initWeldingInfo: unsafe extern "thiscall" fn(
        this: *mut hkpShapeCollection,
        _: hkpWeldingUtility__WeldingType,
    ),
    pub setWeldingInfo: unsafe extern "thiscall" fn(this: *mut hkpShapeCollection, _: u32, _: i16),
}

#[repr(C)]
pub struct hkEnum_enum_hkpShapeCollection__CollectionType_unsigned_char_ {
    pub m_storage: u8,
}
...
pub struct hkpMoppCode {
    // hkBaseObject
    pub vfptr: *const hkpMoppCode__vftable,
    // hkReferencedObject
    pub m_memSizeAndRefCount: u32,
    // hkpMoppCode
    __pdbindgen_padding: [u8; 8],
    pub m_info: hkpMoppCode__CodeInfo,
    pub m_data: hkArray_unsigned_char_hkContainerHeapAllocator_,
    pub m_buildType: hkEnum_enum_hkpMoppCode__BuildType_signed_char_,
}

unsafe impl UpcastToNop<hkReferencedObject> for hkpMoppCode {}

unsafe impl UpcastToNop<hkBaseObject> for hkpMoppCode {}
...
#[repr(C)]
pub struct hkpMoppCode__vftable {
    pub __vecDelDtor: unsafe extern "thiscall" fn(this: *mut hkpMoppCode, _: u32) -> *mut (),
    pub __first_virtual_table_function__: unsafe extern "thiscall" fn(this: *mut hkpMoppCode),
    pub getClassType: unsafe extern "thiscall" fn(this: *const hkpMoppCode) -> *const hkClass,
    pub deleteThisReferencedObject: unsafe extern "thiscall" fn(this: *const hkpMoppCode),
}

#[repr(C)]
pub struct hkpMoppCode__CodeInfo {
    pub m_offset: hkVector4f,
}

#[repr(C)]
pub struct hkEnum_enum_hkpMoppCode__BuildType_signed_char_ {
    pub m_storage: i8,
}
...
#[repr(C)]
pub struct hkEnum_enum_hkpWeldingUtility__WeldingType_unsigned_char_ {
    pub m_storage: u8,
}
...
pub struct hkMoppBvTreeShapeBase {
    // hkBaseObject
    pub vfptr: *const hkMoppBvTreeShapeBase__vftable,
    // hkReferencedObject
    pub m_memSizeAndRefCount: u32,
    // hkcdShape
    pub m_type: hkEnum_enum_hkcdShapeType__ShapeTypeEnum_unsigned_char_,
...
unsafe impl UpcastToNop<hkpBvTreeShape> for hkMoppBvTreeShapeBase {}

unsafe impl UpcastToNop<hkpShape> for hkMoppBvTreeShapeBase {}

unsafe impl UpcastToNop<hkpShapeBase> for hkMoppBvTreeShapeBase {}

unsafe impl UpcastToNop<hkcdShape> for hkMoppBvTreeShapeBase {}

unsafe impl UpcastToNop<hkReferencedObject> for hkMoppBvTreeShapeBase {}

unsafe impl UpcastToNop<hkBaseObject> for hkMoppBvTreeShapeBase {}

impl hkMoppBvTreeShapeBase {
    pub unsafe extern "thiscall" fn __vecDelDtor(&self, a1: u32) -> *mut () {
        ((*self.vfptr).__vecDelDtor)(self as *const _ as *mut _, a1)
    }
...
#[repr(C)]
pub struct hkMoppBvTreeShapeBase__vftable {
    pub __vecDelDtor:
        unsafe extern "thiscall" fn(this: *mut hkMoppBvTreeShapeBase, _: u32) -> *mut (),
    pub __first_virtual_table_function__:
        unsafe extern "thiscall" fn(this: *mut hkMoppBvTreeShapeBase),
    pub getClassType:
        unsafe extern "thiscall" fn(this: *const hkMoppBvTreeShapeBase) -> *const hkClass,
    pub deleteThisReferencedObject: unsafe extern "thiscall" fn(this: *const hkMoppBvTreeShapeBase),
    pub isConvex: unsafe extern "thiscall" fn(this: *const hkMoppBvTreeShapeBase) -> bool,
    pub getAabb: unsafe extern "thiscall" fn(
        this: *const hkMoppBvTreeShapeBase,
        _: *const hkTransformf,
        _: f32,
        _: *mut hkAabb,
    ),
    ...
    pub getCentre:
        unsafe extern "thiscall" fn(this: *const hkMoppBvTreeShapeBase, _: *mut hkVector4f),
    pub getNumCollisionSpheres:
        unsafe extern "thiscall" fn(this: *const hkMoppBvTreeShapeBase) -> i32,
    pub getCollisionSpheres: unsafe extern "thiscall" fn(
        this: *const hkMoppBvTreeShapeBase,
        _: *mut hkSphere,
    ) -> *const hkSphere,
    ...
    pub getContainer:
        unsafe extern "thiscall" fn(this: *const hkMoppBvTreeShapeBase) -> *const hkpShapeContainer,
...
#[repr(C)]
pub struct hkpExtendedMeshShape_2 {
    // hkBaseObject
    pub vfptr: *const hkpExtendedMeshShape__vftable_2,
    // hkReferencedObject
    pub m_memSizeAndRefCount: u32,
    // hkcdShape
    pub m_type: hkEnum_enum_hkcdShapeType__ShapeTypeEnum_unsigned_char_,
    ...
    pub m_userData: u32,
    // hkpShapeContainer
    pub vfptr_2: *const hkpExtendedMeshShape__vftable_2,
    // hkpShapeCollection
    pub m_disableWelding: hkBool,
    pub m_collectionType: hkEnum_enum_hkpShapeCollection__CollectionType_unsigned_char_,
    // hkpExtendedMeshShape_2
...
unsafe impl UpcastToNop<hkpShapeCollection> for hkpExtendedMeshShape_2 {}

unsafe impl UpcastToNop<hkpShape> for hkpExtendedMeshShape_2 {}

unsafe impl UpcastToNop<hkpShapeBase> for hkpExtendedMeshShape_2 {}

unsafe impl UpcastToNop<hkcdShape> for hkpExtendedMeshShape_2 {}

unsafe impl UpcastToNop<hkReferencedObject> for hkpExtendedMeshShape_2 {}

unsafe impl UpcastToNop<hkBaseObject> for hkpExtendedMeshShape_2 {}

unsafe impl UpcastTo<hkpShapeContainer> for hkpExtendedMeshShape_2 {
    fn upcast_to(p: *const Self) -> *const hkpShapeContainer {
        (p as usize + 0x10) as *const _
    }
}

impl hkpExtendedMeshShape_2 {
    pub unsafe extern "thiscall" fn __vecDelDtor(&self, a1: u32) -> *mut () {
        ((*self.vfptr).__vecDelDtor)(self as *const _ as *mut _, a1)
    }
...
#[repr(C)]
pub struct hkpExtendedMeshShape__vftable_2 {
    pub __vecDelDtor:
        unsafe extern "thiscall" fn(this: *mut hkpExtendedMeshShape_2, _: u32) -> *mut (),
    pub getNumChildShapes: unsafe extern "thiscall" fn(this: *const hkpExtendedMeshShape_2) -> i32,
    pub getFirstKey: unsafe extern "thiscall" fn(this: *const hkpExtendedMeshShape_2) -> u32,
    pub getNextKey: unsafe extern "thiscall" fn(this: *const hkpExtendedMeshShape_2, _: u32) -> u32,
    pub getCollisionFilterInfo:
        unsafe extern "thiscall" fn(this: *const hkpExtendedMeshShape_2, _: u32) -> u32,
    pub getChildShape: unsafe extern "thiscall" fn(
        this: *const hkpExtendedMeshShape_2,
        _: u32,
        _: *mut hkpShapeBufferStorage,
    ) -> *const hkpShape,
    pub isWeldingEnabled: unsafe extern "thiscall" fn(this: *const hkpExtendedMeshShape_2) -> bool,
    pub castRayWithCollector: unsafe extern "thiscall" fn(
        this: *const hkpExtendedMeshShape_2,
        _: *const hkpShapeRayCastInput,
        _: *const hkpCdBody,
    ...
    pub getCentre:
        unsafe extern "thiscall" fn(this: *const hkpExtendedMeshShape_2, _: *mut hkVector4f),
    pub getNumCollisionSpheres:
        unsafe extern "thiscall" fn(this: *const hkpExtendedMeshShape_2) -> i32,
    pub getCollisionSpheres: unsafe extern "thiscall" fn(
        this: *const hkpExtendedMeshShape_2,
        _: *mut hkSphere,
    ) -> *const hkSphere,
    ...
    pub setWeldingInfo:
        unsafe extern "thiscall" fn(this: *mut hkpExtendedMeshShape_2, _: u32, _: i16),
...
#[repr(C)]
pub struct hkpExtendedMeshShape__Subpart {
...
#[repr(C)]
pub struct hkpExtendedMeshShape__TrianglesSubpart {
    ...
    pub m_materialBase: *const hkpMeshMaterial,
    pub m_userData: u32,
    // hkpExtendedMeshShape__TrianglesSubpart
    pub m_numTriangleShapes: i32,
    pub m_vertexBase: *const f32,
    pub m_numVertices: i32,
    pub m_indexBase: *const (),
    pub m_vertexStriding: u16,
    pub m_triangleOffset: i32,
    pub m_indexStriding: u16,
    pub m_stridingType: hkEnum_enum_hkpExtendedMeshShape__IndexStridingType_signed_char_,
    pub m_flipAlternateTriangles: i8,
    pub m_extrusion: hkVector4f,
    pub m_transform: hkQsTransformf,
}

unsafe impl UpcastToNop<hkpExtendedMeshShape__Subpart> for hkpExtendedMeshShape__TrianglesSubpart {}

#[repr(C)]
pub struct hkEnum_enum_hkpExtendedMeshShape__IndexStridingType_signed_char_ {
    pub m_storage: i8,
}
...
pub type hkpWeldingUtility__WeldingType = i32;
