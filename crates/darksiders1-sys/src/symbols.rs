...
symbols! {
    ...
    pub static gfc__WorldObject__getWorldObjectID: unsafe extern "thiscall" fn(this: *mut gfc__WorldObject, result: *mut gfc__WorldObject__ID) -> *mut gfc__WorldObject__ID = Text(0xdcc390);
    ...
    pub static gfc__WorldObject__getAnimation: unsafe extern "thiscall" fn(this: *const gfc__WorldObject, result: *mut gfc__AutoRef_gfc__Animation_, _: i32) -> *mut gfc__AutoRef_gfc__Animation_ = Text(0xdd8820);
    ...
    pub static gfc__WorldObject__getNodeRotation: unsafe extern "thiscall" fn(this: *mut gfc__WorldObject, result: *mut gfc__TVector3_float_gfc__FloatMath_, _: *const gfc__HString) -> *mut gfc__TVector3_float_gfc__FloatMath_ = Text(0xdd8940);
    ...
    pub static gfc__WorldObject__getNodePosition: unsafe extern "thiscall" fn(this: *mut gfc__WorldObject, result: *mut gfc__TVector3_float_gfc__FloatMath_, _: *const gfc__HString) -> *mut gfc__TVector3_float_gfc__FloatMath_ = Text(0xde76e0);
    ...
    pub static gfc__WorldObject__getAttachedObjects: unsafe extern "thiscall" fn(this: *mut gfc__WorldObject, result: *mut gfc__Vector_gfc__AutoRef_gfc__WorldObject__0_gfc__CAllocator_) -> *mut gfc__Vector_gfc__AutoRef_gfc__WorldObject__0_gfc__CAllocator_ = Text(0xe0f030);
    pub static gfc__WorldObject__getAttachedTransform: unsafe extern "thiscall" fn(this: *mut gfc__WorldObject, result: *mut gfc__Matrix4) -> *mut gfc__Matrix4 = Text(0xe0f0b0);
    pub static gfc__WorldObject__getAttachedPosition: unsafe extern "thiscall" fn(this: *mut gfc__WorldObject, result: *mut gfc__TVector3_float_gfc__FloatMath_) -> *mut gfc__TVector3_float_gfc__FloatMath_ = Text(0xe0f130);
    pub static gfc__WorldObject__getAttachedRotation: unsafe extern "thiscall" fn(this: *mut gfc__WorldObject, result: *mut gfc__TVector3_float_gfc__FloatMath_) -> *mut gfc__TVector3_float_gfc__FloatMath_ = Text(0xe0f190);
    ...
    pub static gfc__Object3D__getVisualAt: unsafe extern "thiscall" fn(this: *mut gfc__Object3D, result: *mut gfc__AutoRef_gfc__Visual_, _: i32) -> *mut gfc__AutoRef_gfc__Visual_ = Text(0xd888f0);
    pub static gfc__Object3D__containsVisualAt: unsafe extern "thiscall" fn(this: *const gfc__Object3D, _: i32) -> bool = Text(0xd88920);
    pub static gfc__Object3D__getVisualKeys: unsafe extern "thiscall" fn(this: *mut gfc__Object3D, result: *mut gfc__AutoRef_gfc__Value_) -> *mut gfc__AutoRef_gfc__Value_ = Text(0xd88930);
    ...
    pub static gfc__Object3D__getVisualValues: unsafe extern "thiscall" fn(this: *mut gfc__Object3D, result: *mut gfc__AutoRef_gfc__Value_) -> *mut gfc__AutoRef_gfc__Value_ = Text(0xdabce0);
    ...
    pub static gfc__Class__newInstance: unsafe extern "thiscall" fn(this: *mut gfc__Class, result: *mut gfc__AutoRef_gfc__Object_) -> *mut gfc__AutoRef_gfc__Object_ = Text(0xa139f0);
    ...
    pub static gfc__WorldObject__getPosition: unsafe extern "thiscall" fn(this: *mut gfc__WorldObject, result: *mut gfc__TVector3_float_gfc__FloatMath_) -> *mut gfc__TVector3_float_gfc__FloatMath_ = Text(0x91a910);
    ...
    pub static gfc__Object3D__getRagdoll: unsafe extern "thiscall" fn(this: *mut gfc__Object3D, result: *mut gfc__AutoRef_gfc__RagdollMapper_) -> *mut gfc__AutoRef_gfc__RagdollMapper_ = Text(0x577fd0);
    ...
    pub static gfc__WorldObject__getRotation: unsafe extern "thiscall" fn(this: *mut gfc__WorldObject, result: *mut gfc__TVector3_float_gfc__FloatMath_) -> *mut gfc__TVector3_float_gfc__FloatMath_ = Text(0x4cbea0);
    pub static gfc__WorldObject__getScale: unsafe extern "thiscall" fn(this: *mut gfc__WorldObject, result: *mut gfc__TVector3_float_gfc__FloatMath_) -> *mut gfc__TVector3_float_gfc__FloatMath_ = Text(0x4cbec0);
