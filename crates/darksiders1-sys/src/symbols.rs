...
symbols! {
    ...
    pub static gfc__CShapeTransform___Class: *mut gfc__Class = Data(0x6a2d94);
    pub static gfc__CShapeTerrainChunk___Class: *mut gfc__Class = Data(0x6a2d8c);
    pub static gfc__CShapeCapsule___Class: *mut gfc__Class = Data(0x6a2d78);
    pub static gfc__CShapeMesh___Class: *mut gfc__Class = Data(0x6a2d84);
    pub static gfc__CShapeSphere___Class: *mut gfc__Class = Data(0x6a2d88);
    pub static gfc__CShapeCylinder___Class: *mut gfc__Class = Data(0x6a2d80);
    pub static gfc__CShapeTerrainNode___Class: *mut gfc__Class = Data(0x6a2d90);
    pub static gfc__CShapeBox___Class: *mut gfc__Class = Data(0x6a2d74);
    pub static gfc__CShapeComposite___Class: *mut gfc__Class = Data(0x6a2d7c);
    ...
    pub static gfc__CShape__CShape: unsafe extern "thiscall" fn(this: *mut gfc__CShape) = Text(0xbc09f0);
    pub static gfc__CShapeCapsule__CShapeCapsule: unsafe extern "thiscall" fn(this: *mut gfc__CShapeCapsule) = Text(0xbc1050);
    pub static gfc__CShapeCapsule___CShapeCapsule: unsafe extern "thiscall" fn(this: *mut gfc__CShapeCapsule) = Text(0xbc1080);
    pub static gfc__CShapeCapsule__CShapeCapsule_2: unsafe extern "thiscall" fn(this: *mut gfc__CShapeCapsule, _: f32, _: f32) = Text(0xbc1090);
    pub static gfc__CShapeCylinder__CShapeCylinder: unsafe extern "thiscall" fn(this: *mut gfc__CShapeCylinder) = Text(0xbc1630);
    pub static gfc__CShapeCylinder__CShapeCylinder_2: unsafe extern "thiscall" fn(this: *mut gfc__CShapeCylinder, _: f32, _: f32) = Text(0xbc1660);
    pub static gfc__CShapeMesh__CShapeMesh: unsafe extern "thiscall" fn(this: *mut gfc__CShapeMesh) = Text(0xbc1af0);
    pub static gfc__CShapeMesh__CShapeMesh_2: unsafe extern "thiscall" fn(this: *mut gfc__CShapeMesh, _: *const gfc__HString, _: i32) = Text(0xbc1bb0);
    pub static gfc__CShapeMesh___CShapeMesh: unsafe extern "thiscall" fn(this: *mut gfc__CShapeMesh) = Text(0xbc1c30);
    pub static gfc__CShapeTerrainChunk__CShapeTerrainChunk: unsafe extern "thiscall" fn(this: *mut gfc__CShapeTerrainChunk) = Text(0xbc1f50);
    pub static gfc__CShapeTerrainChunk__CShapeTerrainChunk_2: unsafe extern "thiscall" fn(this: *mut gfc__CShapeTerrainChunk, _: *mut gfc__TerrainChunk) = Text(0xbc1fc0);
    pub static gfc__CShapeTerrainChunk___CShapeTerrainChunk: unsafe extern "thiscall" fn(this: *mut gfc__CShapeTerrainChunk) = Text(0xbc1ff0);
    pub static gfc__CShapeTerrainNode__CShapeTerrainNode: unsafe extern "thiscall" fn(this: *mut gfc__CShapeTerrainNode) = Text(0xbc2240);
    pub static gfc__CShapeTerrainNode__CShapeTerrainNode_2: unsafe extern "thiscall" fn(this: *mut gfc__CShapeTerrainNode, _: *mut gfc__TerrainNode) = Text(0xbc22b0);
    pub static gfc__CShapeTerrainNode___CShapeTerrainNode: unsafe extern "thiscall" fn(this: *mut gfc__CShapeTerrainNode) = Text(0xbc22e0);
    pub static gfc__CShapeBox__CShapeBox: unsafe extern "thiscall" fn(this: *mut gfc__CShapeBox) = Text(0xbc5fb0);
    pub static gfc__CShapeBox__CShapeBox_2: unsafe extern "thiscall" fn(this: *mut gfc__CShapeBox, _: f32, _: f32, _: f32) = Text(0xbc6010);
    pub static gfc__CShapeBox__CShapeBox_3: unsafe extern "thiscall" fn(this: *mut gfc__CShapeBox, _: *const gfc__TVector3_float_gfc__FloatMath_) = Text(0xbc6050);
    pub static gfc__CShapeSphere__CShapeSphere: unsafe extern "thiscall" fn(this: *mut gfc__CShapeSphere) = Text(0xbc7150);
    pub static gfc__CShapeSphere__CShapeSphere_2: unsafe extern "thiscall" fn(this: *mut gfc__CShapeSphere, _: f32) = Text(0xbc71b0);
    pub static gfc__CShapeTransform__CShapeTransform: unsafe extern "thiscall" fn(this: *mut gfc__CShapeTransform) = Text(0xbc7d40);
    pub static gfc__CShapeTransform___CShapeTransform: unsafe extern "thiscall" fn(this: *mut gfc__CShapeTransform) = Text(0xbc7dd0);
    pub static gfc__CShapeTransform__CShapeTransform_2: unsafe extern "thiscall" fn(this: *mut gfc__CShapeTransform, _: *const gfc__Matrix4, _: gfc__AutoRef_gfc__CShape_) = Text(0xbc7e40);
    pub static gfc__CShapeComposite__CShapeComposite: unsafe extern "thiscall" fn(this: *mut gfc__CShapeComposite) = Text(0xbcde20);
    pub static gfc__CShapeComposite___CShapeComposite: unsafe extern "thiscall" fn(this: *mut gfc__CShapeComposite) = Text(0xbcde90);
    ...
    pub static gfc__CShape___CShape: unsafe extern "thiscall" fn(this: *mut gfc__CShape) = Text(0x9b33c0);
    pub static gfc__CShapeBox___CShapeBox: unsafe extern "thiscall" fn(this: *mut gfc__CShapeBox) = Text(0x9b9b20);
    pub static gfc__CShapeSphere___CShapeSphere: unsafe extern "thiscall" fn(this: *mut gfc__CShapeSphere) = Text(0x9b9b30);
    pub static gfc__CShapeCylinder___CShapeCylinder: unsafe extern "thiscall" fn(this: *mut gfc__CShapeCylinder) = Text(0x9b9b40);
