...
fn build_meshbuilder() -> gfc::AutoRef<gfc::MeshBuilder> {
    unsafe {
        ...
        let sub_mesh = Heap::new({
            ...
            sub_mesh.MaterialName = gfc::String::from_cstr(cstr!("sphere")).into_raw();
            ...
            tex0.add(gfc::TVector3::new(0.0, 0.0, 0.0));
            tex0.add(gfc::TVector3::new(0.0, 1.0, 0.0));
            tex0.add(gfc::TVector3::new(1.0, 1.0, 0.0));
            tex0.add(gfc::TVector3::new(1.0, 0.0, 0.0));
            tex0.add(gfc::TVector3::new(0.0, 1.0, 0.0));
            tex0.add(gfc::TVector3::new(0.0, 0.0, 0.0));
            tex0.add(gfc::TVector3::new(1.0, 0.0, 0.0));
            tex0.add(gfc::TVector3::new(1.0, 1.0, 0.0));
